...
for test_point in range(500):
    ...
    # error_psi = [calculate_error(trace[:, 3], target[3])]/np.pi*180
...
print('error_psi', np.mean(error_container[3]/np.pi*180, axis=0), np.std(error_container[3]/np.pi*180, axis=0))
...
x = np.load(path + '/Case3_Statics.npy')
print(x)
